...
public final class ImageRenderer {
    ...
    public BufferedImage render(final VirtualBuilding.Group<? extends MindustryImage> group) {
        final var image =
        ...
        try (final var scope = new GraphicsScope(image)) {
            ...
            for (final var building : group.elements()) {
                ...
                try (final var sub =
                    ...
                    this.renderWith(sub.graphics(), building.data());
                }
            }
        }
        return image;
    ...
    private void renderWith(final Graphics2D graphics, final MindustryImage data) {
        switch (data) {
