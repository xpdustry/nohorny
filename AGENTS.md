...
- You SHOULD avoid doing defensive programming for generic internal code (null checks, assertions, etc...) unless you are working with the public api or serialization.
...
- You MUST NOT compile the project when reviewing code. Otherwise, You MUST USE the --no-daemon flag.